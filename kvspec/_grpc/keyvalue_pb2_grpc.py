...
class KeyValueStoreStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Ls = channel.unary_unary(
                '/keyvaluestore.KeyValueStore/Ls',
                request_serializer=keyvalue__pb2.GetBytesRequest.SerializeToString,
                response_deserializer=keyvalue__pb2.LsReply.FromString,
                )
...
def add_KeyValueStoreServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Ls': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=keyvalue__pb2.LsReply.SerializeToString,
            ),
...
class KeyValueStore(object):
    ...
    def Ls(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/keyvaluestore.KeyValueStore/Ls',
            keyvalue__pb2.GetBytesRequest.SerializeToString,
            keyvalue__pb2.LsReply.FromString,
